namespace AtomicTorch.CBND.CoreMod.UI.Controls.Game.WorldObjects.PowerGrid
{
    ...
    public partial class EnergyRepairStationItemSlot : BaseUserControl, IItemSlotControl
    {
        private ItemSlotControl itemSlotControl;

        private ViewModelEnergyRepairStationItemSlot viewModel;
        ...
        {
            this.DataContext = this.viewModel = new ViewModelEnergyRepairStationItemSlot();
            this.RefreshItem();
        }
